...
public:
     ...
     */
    static flatbuffers::Offset<sparetools::bpm::BPMUpdate> createBPMUpdate(
        float bpm,
        float confidence,
        float signal_level,
     ...
     * @return Offset to the created message
     */
    static flatbuffers::Offset<sparetools::bpm::StatusUpdate> createStatusUpdate(
     ...
     */
    static const sparetools::bpm::BPMUpdate* deserializeBPMUpdate(
     ...
     */
    static const sparetools::bpm::StatusUpdate* deserializeStatusUpdate(
        const std::vector<uint8_t>& buffer);
